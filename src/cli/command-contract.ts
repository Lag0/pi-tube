...
export const HELP_EXAMPLES = [
  ...
  `${COMMAND_IDENTITY} setup skills --non-interactive`,
...
export const HELP_NOTES = [
  ...
  "`setup skills` is interactive by default for human installs.",
  "Use `setup skills --non-interactive` for AI/automation (enforces `--yes --global` symlink install).",
