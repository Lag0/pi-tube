...
Plans:
- [ ] 01-01: Bootstrap Bun + TypeScript project structure and command entrypoint
- [ ] 01-02: Port base CLI command routing and shared flags/help UX
...
|-------|----------------|--------|-----------|
| 1. Bun/TS Foundation | 0/4 | Not started | - |
